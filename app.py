...
from parsers.easy_parser import get_data, get_keyskills, get_average_salary_for_skill, \
    create_diagramm_skills_salary, create_diagram_popular_skills
from parsers.hard_parser import main
app = Flask(__name__)
...
def get_show():
    ...
    json = get_average_salary_for_skill(json)
    statistic_skills = get_keyskills(json)
